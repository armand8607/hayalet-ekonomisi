...
static func kos() -> int:
	...
	print("ULKE-ICI mekanizmayla GECTI: kapali ekonomi tek basina kriz uretiyor.")
	print("")
	print("NOT -- bu blok bir kez daha guncellendi. Onceki hali 'VT/Y 0 ile")
	print("-0.08 arasinda kriz sayisi neredeyse sabit' diyordu ve bunu")
	print("krizlerin ulke-ici oldugunun EK KANITI sayiyordu. O duzluk gercek")
	print("degildi: talep hesabi tek yonluydu (`max(VT,0)`), yani giden deger")
	print("satin alma gucunden DUSULMUYORDU. Iki yonlu hale getirilince tarama")
	print("egim kazandi (toplam 34 -> 37, bunalim 4 -> 5). Kapali ekonominin")
	print("kriz urettigi dogru; transferin etkisiz oldugu YANLISTI.")
	print("")
